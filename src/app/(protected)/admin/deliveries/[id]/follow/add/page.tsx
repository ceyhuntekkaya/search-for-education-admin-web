...
const CreateVehicleFollow = () => {
    ...
    return (
        <div className="space-y-6">
            <PageHeader/>
            <VehicleFollowForm deliveryId={deliveryId} onSubmit={createVehicleFollow} vehicles={vehicles} vehicleDrivers={vehicleDrivers}/>
        </div>
    );
};

export default CreateVehicleFollow;