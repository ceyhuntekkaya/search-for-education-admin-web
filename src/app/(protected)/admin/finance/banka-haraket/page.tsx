...
export default function MuavinPage() {
    const {bankaServisHareketiList, fetchBankaHareket, loading, error} = useSql();
    ...
    function sumValues() {
        return bankaServisHareketiList.reduce((toplam, item) => {
        ...
        <div className="space-y-6">
            ...
            <div>
                <div className="p-6 pt-0">
                    <DynamicTable columns={columns} data={bankaServisHareketiList}/>
                </div>
