...
export default function MuavinPage() {
    const {bankaMuavinIslemiList, fetchBankaMuavin, loading, error} = useSql();
    ...
    function sumValues() {
        return bankaMuavinIslemiList.reduce((toplam, item) => {
        ...
        <div className="space-y-6">
            ...
            <div>
                <div className="p-6 pt-0">
                    <DynamicTable columns={columns} data={bankaMuavinIslemiList}/>
                </div>
